...
class SledClient:
            ...
            for i in range(cCount):
                ...
                print(
                    "  component size: {}\n  component type: {} ({})\n  component frame: {}\n  component time: {}".format(
                        cSize, self.cTypes[cType], cType, cFrame, cTime / 1E6))
                if cType == 1:  # 3D
                    ...
                    for j in range(tCount):
                        ...
                        pointer += 28
                        print("  tool[{}]: ({}, {}, {}, {})({}, {}, {}) +/- {} m".format(j, x / 1E3, y / 1E3, z / 1E3,
                                                                                         delta / 1E3))
    ...
    def startThread(self):
        ...
        logging.info(
            "Timing error estimate: delay: {:f}, variation: {:f} (from {} packages)".format(delay, np.std(tDifference),
                                                                                            nPackage))
